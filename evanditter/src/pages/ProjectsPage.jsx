    ...
    <div className="min-h-screen">
      ...
      <div className="min-h-[50vh] flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center pt-8 md:pt-0 pb-1 md:pb-0 min-h-[25vh] md:min-h-[50vh]">
          <div className="text-center px-12 py-8">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-xl">
              Explore my portfolio of machine learning, data engineering, mobile
              development, and small ad-hoc python projects all featuring modern
              technologies and innovative solutions. From this full-stack web app
              (evanditter.com) to creative machine learning experiments.
            </p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 relative overflow-hidden min-h-[25vh] md:min-h-[50vh]">
          <img
            src="/src/images/coding_projects_image.jpg"
            alt="Coding Projects"
