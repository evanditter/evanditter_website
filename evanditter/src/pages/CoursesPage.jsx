      ...
      <div className="max-container px-4 mx-auto">
        <div className="min-h-[50vh] flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 flex items-start justify-center pt-16 md:pt-24 pb-1 md:pb-0 min-h-[25vh] md:min-h-[50vh]">
            <div className="max-w-lg mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-xl">
                I'm currently developing comprehensive courses on programming
                basics with Python, Introduction to Machine Learning, and modern
                programming technologies. Each course will include hands-on
                projects, real-world examples, and practical skills you can
                apply immediately.
              </p>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 relative overflow-hidden flex items-center justify-center min-h-[25vh] md:min-h-[50vh]">
            <img
              src="/images/courses_home_page.png"
              alt="Courses"
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow">
                <div className="text-blue-500 dark:text-blue-400 text-2xl mb-3">
                  🐍
                </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow">
                <div className="text-purple-500 dark:text-purple-400 text-2xl mb-3">
                  🤖
                </div>
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  Machine Learning
              ...
              <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow">
                <div className="text-green-500 dark:text-green-400 text-2xl mb-3">
                  🎯
                </div>
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  Practical Projects
