        ...
        <div className="w-full md:w-1/2 flex items-center justify-center pt-8 md:pt-0 pb-1 md:pb-0 min-h-[25vh] md:min-h-[50vh]">
          <div className="text-center px-12 py-8">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-xl">
              Get personalized programming tutoring tailored to your needs. Whether you're just starting
              or looking to level up your skills, I'm here to help you succeed in your coding journey.
            </p>
          </div>
        </div>
      ...
      <section className="max-container px-8 py-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                Engineering at the University of Minnesota - Twin Cities, where
                I earned my Bachelor's of Science in Computer Science. During my
                studies, I served as a Teaching Assistant for Data Structures
                and Algorithms, giving me valuable experience in breaking down
                complex programming concepts for students at various skill
                levels.
              </p>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                My professional journey has taken me from Backend Software
                Engineer to Data Engineer and now Machine Learning Engineer at
                JPMorgan Chase, working extensively with SQL and Python across
                multiple cloud providers including AWS and Azure. I have
                hands-on experience with modern data technologies like Snowflake
                and Databricks, and have previously tutored programming and
                beginner Python with a professional tutoring service.
              </p>
              <p className="text-gray-600 dark:text-gray-300">
                This unique combination of theoretical knowledge and practical
                industry experience allows me to break down complex concepts
                into digestible, understandable parts. My approach focuses on
                building confidence through understanding fundamentals,
                practical application, and personalized learning strategies that
                work for each student's unique style.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold text-[#181A2A] dark:text-white mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#181A2A] dark:text-white mb-4 mt-8">
                Location
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-center text-white">
          ...
          <p className="text-lg mb-6 opacity-90">
            Let's work together to achieve your academic goals. I offer flexible
            scheduling and personalized lesson plans tailored to your learning
            style.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm">
              Online and in-person sessions available with scheduling that works
